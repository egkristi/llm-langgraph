# LLM LangGraph — Licensing

LLM LangGraph uses a **dual-license model**: open source for the community,
...
LLM LangGraph is licensed under the
...
1. Use LLM LangGraph commercially with **>50 users** and **>$5M revenue/year**
2. Distribute LLM LangGraph inside a product **without** releasing your source under AGPLv3
3. Offer LLM LangGraph as a **hosted/managed service** without releasing modifications
...
**The SaaS loophole:** MIT and Apache 2.0 allow cloud providers to offer LLM LangGraph
...
Open an issue: https://github.com/egkristi/llm-langgraph/issues
